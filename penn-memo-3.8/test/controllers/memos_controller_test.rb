...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { author: @memo.author, content: @memo.content, date: @memo.date, priority: @memo.priority, tag_id: @memo.tag_id, title: @memo.title } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { author: @memo.author, content: @memo.content, date: @memo.date, priority: @memo.priority, tag_id: @memo.tag_id, title: @memo.title } }
